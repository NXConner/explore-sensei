  ...
  paths: {
    '/functions/v1/ai-chat': {
      post: {
        ...
        requestBody: {
          required: true,
          content: { 'application/json': { schema: { type: 'object', properties: { messages: { type: 'array', items: { type: 'object' } } } } } }
        },
    ...
    '/functions/v1/analyze-asphalt': {
      post: {
        ...
        requestBody: {
          required: true,
          content: { 'application/json': { schema: { type: 'object', properties: { imageData: { type: 'string' } } } } }
        },
        responses: { '200': { description: 'OK' } }
      }
    }
